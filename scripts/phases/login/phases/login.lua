...
function drawLoginPhase(countCerp)
    ...
    roundRectangle("fill", loginImageX, loginImageY + 220, loginEntryImage:getWidth(), loginEntryImage:getHeight() - 220,
        20)

    love.graphics.setColor(1, 1, 1, countCerp)
    love.graphics.draw(loginEntryImage, loginImageX, loginImageY)

    love.graphics.draw(bqLogo, (love.graphics.getWidth() / 2) - ((bqLogo:getWidth() * logoScale) * 0.5), loginImageY - 90,
        0, logoScale)
    ...
    love.graphics.printf("Server: " .. servers[selectedServer].name .. "\nClick to change", loginImageX + 50,
        loginImageY + 460, 262, "center")
end
